import {Patient} from "../03-interfaces/01-object-class-interfaces";
import {ArrayList} from "./array-list-task/array-list";
import {MyIterator} from "./array-list-task/my-iterator";
